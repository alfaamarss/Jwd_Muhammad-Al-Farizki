...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `book_wisata` (`Nama`, `Email`, `tanggal_waktu`, `tujuan_destinasi`, `Aksi`) 
            VALUES ('$name', '$email', '$datetime', '$destination', '')";
            ...
            <div class="booking p-5">
                <div class="row g-5 align-items-center">
                    <div class="col-md-6 text-white">
                        ...
                        <p class="mb-4">Tidak perlu keluar rumah untuk merencanakan liburan impian. Dengan online booking, semua kebutuhan perjalananmu dapat diatur dengan cepat dan mudah.</p>
                        <p class="mb-4">Cukup beberapa klik, dan kamu siap untuk petualangan berikutnya!</p>
                    </div>
                    <div class="col-md-6">
